<div class="nirweb_ticket_base">
    ...
    <div class="top_box_send_ticket">
        <div class="head_send_ticket_wpyar">
            ...
            if (is_plugin_active('wpyar_panel/wpyar_panel.php')) {
                $page = slug_page . '?endp=nirweb-ticket';
            } else {
            ...
            <a href=" <?php echo $page; ?> "
               class="btn btn_back_wpyt"><?php echo __('Back To List Tickets', 'nirweb-support') ?></a>
        </div>
        ...
        <div class="not_found_answer" <?php if (!$faq) {
    ...
    <form class="form__global__ticket_new shadow__wpys" id="send_ticket_form" method="post"
          enctype="multipart/form-data" <?php if ($faq) {
        ...
        <div class="row_nirweb_ticket_send">
            <div class="w-50">
                ...
                <input type="text" id="nirweb_ticket_frm_subject_send_ticket_user"
            ...
            <div class="w-50">
                <div class="department_form_user_send">
                    ...
                    <div class="select_custom_wpyar">
                        <div class="custom_input_wpyar_send_ticket" id="nirweb_ticket_frm_department_send_ticket_user"
                             data-id="-1" data-user="0">
        ...
        <div class="row_nirweb_ticket_send">
            <div class="w-50">
                ...
                <div class="select_custom_wpyar">
                    <div class="custom_input_wpyar_send_ticket" id="nirweb_ticket_frm_priority_send_ticket_user"
                         data-id="-1">
            ...
            <div class="w-50">
                ...
                <div class="select_custom_wpyar">
                    ...
                    <ul>
                        ...
                        foreach ($rep as $row):
                            echo '<li data-id="' . $row->ID . '">' . $row->post_title . '</li>';
                        endforeach;
                        echo '</ul></div>';
                        } ?>
                </div>
        ...
        <div class="row_nirweb_ticket_send">
            <div class="w-100">
                ...
                <textarea id="nirweb_ticket_frm_content_send_ticket_user"
                          name="nirweb_ticket_frm_content_send_ticket_user"
                          placeholder="<?php echo __('Enter Message please', 'nirweb-support'); ?>"></textarea>
            </div>
        </div>
        <!------ Upload File ----->
        <div class="row_nirweb_ticket_send wpyar_upfile_base">
            <div class="upfile_wpyartick">
                ...
                <input type="file" name="main_image" id="main_image"
                       accept="<?php echo wpyar_ticket['mojaz_file_upload_user_wpyar'] ?>">
            </div>
        </div>
        <!-- buttons row-->
            ...
            if (<?php echo $shart; ?>) {
                ...
                jQuery.ajax({
                    ...
                    success: function (response) {
                        ...
                        jQuery('.base_loarder').css('display', 'none');
                        alert_success("<?php echo __('Send Ticket Success', 'nirweb-support') ?>");
                        setTimeout(() => {
                            location.reload();
                        }, 3000);
