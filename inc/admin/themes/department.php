...
<div class="wapper flex">
	<div class="right_FAQ" >
		<form method="post">
			...
			<div class="question__faq flex flexd-cul" >
				<label class="w-100"><b><?php echo esc_html__( 'Support', 'nirweb-support' ); ?></b></label>
				<?php
				echo '<select id="nirweb_ticket_support_department" name="nirweb_ticket_support_department">';
				echo '<option value="-1">' . esc_html__( 'Select Support User', 'nirweb-support' ) . '</option>';
...
<table class="wp-list-table widefat striped">
			...
			<tr>
				...
				<th><?php echo esc_html__( 'Support', 'nirweb-support' ); ?></th>
