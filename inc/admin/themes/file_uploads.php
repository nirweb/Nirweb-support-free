            ...
            <form method="post" id="list_all_user_files" name="list_all_user_files[]">
                ...
                <table class="wpyt_table">
                    ...
                    <tr>
                        ...
                        <th style="width: 80px"><?php echo esc_html__( 'Image File', 'nirweb-support' ); ?></th>
                        <th><?php echo esc_html__( 'Link File', 'nirweb-support' ); ?></th>
                    </tr>
                    </thead>
                    <tbody>
					...
					foreach ( $files[0] as $row ) :
                        ...
                        <tr>
                            ...
                            <th><a href="<?php echo esc_url_raw( $row->url_file ); ?>"
                                   target="_blank"><?php echo esc_html__( 'Show Image', 'nirweb-support' ); ?></a></th>
                        </tr>
					<?php endforeach ?>
                    ...
                    <tr>
                        <th></th>
                        <th><?php echo esc_html__( 'Image File', 'nirweb-support' ); ?></th>
                        <th><?php echo esc_html__( 'Link File', 'nirweb-support' ); ?></th>
                    </tr>
                    </tfoot>
                </table>
