...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_localize_script(
        ...
        [
            ...
            'ok_text' => __('Ok', 'nirweb-support'),
            'cancel_text' => __('Cancel', 'nirweb-support'),
        ]
    );
});
//~~~~~~~~~~~~START Create Menu~~~~~~~~~~
...
?>
  <?php
    ...
    ?>
        ...
        <a class="nirweb_ticket_logo" href="<?php echo $page ?>" style="<?php
...
if (!function_exists('ago_ticket_nirweb')) {
    ...
    {
        echo esc_html(human_time_diff($post_date,  time())) . __(' ago', 'nirweb-support');
    }
}