...
add_action(
	...
	function () {
		...
		$wpdb->delete( $table_name, array( 'priority_id' => 1 ) );
		$wpdb->delete( $table_name, array( 'priority_id' => 2 ) );
		$wpdb->delete( $table_name, array( 'priority_id' => 3 ) );
...
PRIMARY KEY (status_id)
		...
		$wpdb->delete( $table_name, array( 'status_id' => 1 ) );
		$wpdb->delete( $table_name, array( 'status_id' => 2 ) );
		$wpdb->delete( $table_name, array( 'status_id' => 3 ) );
		$wpdb->delete( $table_name, array( 'status_id' => 4 ) );
